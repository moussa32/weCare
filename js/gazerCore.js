(function(window) {
  ...
  var scrollMarginPercent = 0.13;
  var scrollPercent = 0.30;
  var scrollDuration = 999;
  ...
  // ui vars
  let scrollMarginPercentInput = document.querySelector('#scroll-margin-perc');
  let scrollPercentInput = document.querySelector('#scroll-perc');
  let scrollDurationInput = document.querySelector('#scroll-duration');
  let numToAverageInput = document.querySelector('#number-avg');
  let saveDataInput = document.querySelector('#save-data');
  let hideCamera = document.querySelector('#hide-camera');
  ...
  hideCamera.addEventListener('click', function(e) {
    document.querySelector('video').remove();

    let allCanvas = document.querySelectorAll('canvas');
    allCanvas.forEach((item, i) => {
      item.remove();
    });
